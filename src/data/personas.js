...
export const universalPool = {
  hooks: {
    [VIBES.AUTHORITY]: [
      ...
      { fr: "Le scale est une science de la soustraction, pas de l'addition.", en: "Scaling is a science of subtraction, not addition.", es: "Escalar es ciencia de restar, no de sumar." },
      { fr: "Arrêtez de vendre des specs. Vendez le futur de votre client.", en: "Stop selling specs. Sell your customer's future.", es: "Deja de vender fichas técnicas. Vende el futuro de tu cliente." },
      { fr: "Votre autorité est votre seul avantage concurrentiel durable.", en: "Your authority is your only sustainable competitive advantage.", es: "Tu autoridad es tu única ventaja duradera hoy." }
    ],
    [VIBES.VULNERABILITY]: [
      ...
      { fr: "J'ai avoué à mon équipe que je n'avais plus de plan. Ils ne sont pas partis.", en: "I told my team I had no more plan. They didn't leave.", es: "Le dije a mi equipo que no tenía plan. Nadie se fue." },
      { fr: "Après 100 refus, j'ai réalisé que c'était moi le problème. Pas le produit.", en: "After 100 rejections, I realized I was the problem. Not the product.", es: "Tras 100 rechazos, entendí que el problema era yo. No el producto." }
    ],
    [VIBES.CONTRARIAN]: [
      ...
      { fr: "Le networking, c'est pour ceux qui n'ont rien à offrir.", en: "Networking is for those who have nothing to offer.", es: "El networking es para los que no tienen nada que ofrecer." }
    ],
    [VIBES.ACTIONABLE]: [
      ...
      { fr: "En optimisant ma tagline, j'ai reçu 10 demandes de leads en 24h.", en: "By optimizing my tagline, I got 10 lead requests in 24h.", es: "Optimizando mi tagline, recibí 10 leads en apenas 24h." },
      { fr: "Comment transformer vos 'merci' en 'quand commençons-nous ?'.", en: "How to turn 'thanks' into 'when do we start?'.", es: "Cómo convertir un 'gracias' en un '¿cuándo empezamos?'." }
    ],
    [VIBES.TRANSFORMATION]: [
      ...
      { fr: "J'ai réalisé que l'on ne devient pas ce que l'on veut, mais ce que l'on tolère.", en: "I realized we don't become what we want, but what we tolerate.", es: "Entendí que no nos convertimos en lo que queremos, sino en lo que toleramos." }
    ]
  },
  stories: {
    [VIBES.AUTHORITY]: [
...
export const personas = {
  founder: {
    ...
    lenses: {
      fr: { hooks: [], reframes: ["C'était un signal stratégique.", "Le marché dicte les règles.", "L'exécution est la seule métrique.", "Vendre avant de construire.", "Le scale demande de la brutalité."], lessons: [], ctas: ["Et vous, quel est votre pivot ?", "Qui d'autre a vécu ça ?", "Hustle ?", "Un avis ?"], hashtags: ["#Startup", "#Founder", "#Business", "#Strategy", "#Scale"] },
      en: { hooks: [], reframes: ["It was a strategic signal.", "The market dictates the rules.", "Execution is the only metric.", "Sell before you build.", "Scaling requires brutality."], lessons: [], ctas: ["What is your biggest pivot?", "Who else relates?", "Hustle?", "Thoughts?"], hashtags: ["#Startup", "#Founder", "#Business", "#Strategy", "#Scale"] },
      es: { hooks: [], reframes: ["Fue una señal clave.", "El mercado manda hoy.", "La ejecución es la única métrica.", "Vende antes de construir.", "Escalar exige brutalidad."], lessons: [], ctas: ["¿Cuál ha sido tu mayor pivot?", "¿Alguien más?", "¿Hustle?", "¿Opiniones?"], hashtags: ["#Startup", "#Founder", "#Negocios", "#Estrategia", "#Escalar"] }
    }
  },
  recruiter: {
    id: "recruiter",
    ...
    lenses: {
      fr: { hooks: [], reframes: ["Un CV ne dit pas tout.", "Le soft skill est roi.", "Derrière chaque profil, un humain.", "La culture bat le talent brut.", "Recruter c'est écouter."], lessons: [], ctas: ["Candidat ou Recruteur ? Dites-moi tout.", "D'accord ?", "Impact ?", "Un CV en DM ?"], hashtags: ["#Hiring", "#HR", "#Recrutement", "#HumanFirst", "#Talent"] },
      en: { hooks: [], reframes: ["A resume isn't everything.", "Soft skills rule.", "Behind every profile is a human.", "Culture beats raw talent.", "Hiring is listening."], lessons: [], ctas: ["Candidate or Recruiter?", "Agree?", "Impact?", "DM for CV?"], hashtags: ["#Hiring", "#HR", "#Recruiting", "#HumanFirst", "#Talent"] },
      es: { hooks: [], reframes: ["Un CV no te cuenta toda la película.", "La actitud ante todo.", "Detrás de cada perfil hay una persona.", "La cultura gana al talento.", "Contratar es escuchar."], lessons: [], ctas: ["¿Reclutador o candidato?", "¿Qué piensas?", "¿Impacto?", "¿Enviar CV?"], hashtags: ["#RRHH", "#Contratación", "#Talento", "#Empleo"] }
    }
  },
  tech_manager: {
    id: "tech_manager",
    ...
    lenses: {
      ...
      es: { hooks: [], reframes: ["Contrato a personas, no a robots.", "No le temas a tu legacy code.", "La tecnología es un medio, no el fin.", "Deuda técnica = Deuda vital.", "Simplifica antes de teclear."], lessons: [], ctas: ["¿Cómo gestionas tu deuda técnica?", "¿Opiniones?", "¿Legacy o Clean?", "¿Dev o Lead?"], hashtags: ["#GestiónTech", "#Liderazgo", "#CTO", "#Ingeniería", "#DeudaTécnica"] }
    }
  },
  sales_shark: {
    id: "sales_shark",
    ...
    lenses: {
      fr: { hooks: [], reframes: ["A B C. Always Be Closing.", "La vente commence au non.", "Pas de closing, pas de business.", "Le pipe est une religion.", "Vendre avant de pitcher."], lessons: [], ctas: ["Quel est votre MRR cible ?", "Let's go !", "Closing ?", "Vos KPIs ?"], hashtags: ["#Sales", "#Growth", "#Closer", "#Money", "#Pipeline"] },
      en: { hooks: [], reframes: ["Always Be Closing.", "Sale starts at no.", "No closing, no business.", "Pipe is a religion.", "Sell before you pitch."], lessons: [], ctas: ["What's your MRR target?", "Let's go!", "Closing?", "KPIs?"], hashtags: ["#Sales", "#Growth", "#Closer", "#Money", "#Pipeline"] },
      es: { hooks: [], reframes: ["Siempre listos para cerrar.", "La venta real empieza en el 'No'.", "Sin cierre no hay paraíso.", "El pipeline es una religión.", "Vender antes de pitchear."], lessons: [], ctas: ["¿Cuál es tu cuota?", "¡A por ellos!", "¿Cierre?", "¿KPIs?"], hashtags: ["#Ventas", "#Close", "#Growth", "#Dinero", "#Pipeline"] }
    }
  },
  ai_prophet: {
    id: "ai_prophet",
    ...
    lenses: {
      fr: { hooks: [], reframes: ["L'IA ne te remplacera pas. Celui qui l'utilise si.", "AGI arrive plus vite qu'on le pense.", "Prompting is the new coding.", "L'orchestration avant l'exécution.", "Zéro code, 100% impact."], lessons: [], ctas: ["LaSingularity est en route ?", "Prompting > Coding ?", "Prêt ?", "Peur ?"], hashtags: ["#AI", "#Tech", "#FutureOfWork", "#AGI", "#LLM"] },
      en: { hooks: [], reframes: ["AI won't replace you. The guy using it will.", "AGI is faster than you think.", "Prompting is the new coding.", "Orchestrate, don't execute.", "Zero code, 100% impact."], lessons: [], ctas: ["AGI is coming?", "Thoughts?", "Ready?", "Scared?"], hashtags: ["#AI", "#Tech", "#FutureOfWork", "#AGI", "#LLM"] },
      es: { hooks: [], reframes: ["La inteligencia artificial no te reemplazará, lo hará otro.", "La singularidad está cerca.", "El prompt es el nuevo código.", "Director, no obrero.", "Cero código, impacto total."], lessons: [], ctas: ["¿Opiniones sobre GPT-5?", "¿AGI?", "¿Listo?", "¿Miedo?"], hashtags: ["#IA", "#Futuro", "#Tech", "#AGI", "#LLM"] }
    }
  },
  productivity_monk: {
    ...
    lenses: {
      fr: { hooks: [], reframes: ["Dopamine detox pendant 3 mois.", "Le sommeil est la seule drogue autorisée.", "La discipline bat le talent.", "Le deep work est sacré.", "Éliminez avant d'ordonner."], lessons: [], ctas: ["Quelle est votre routine matinale ?", "Routine ?", "Focus ?", "Biohack ?"], hashtags: ["#Productivity", "#Habits", "#Routine", "#DeepWork", "#Biohacking"] },
      en: { hooks: [], reframes: ["Dopamine detox for 3 months.", "Sleep is the only valid drug.", "Discipline beats talent.", "Deep work is sacred.", "Eliminate before ordering."], lessons: [], ctas: ["What is your morning routine?", "Routine?", "Focus?", "Biohack?"], hashtags: ["#Productivity", "#Habits", "#Routine", "#DeepWork", "#Biohacking"] },
      es: { hooks: [], reframes: ["Desintoxicación mental y baños fríos.", "El sueño reina.", "La disciplina supera al talento.", "El deep work es sagrado.", "Elimina antes de organizar."], lessons: [], ctas: ["Cuenta sobre tu rutina matinal.", "¿Rutina?", "¿Enfoque?", "¿Biohack?"], hashtags: ["#Productividad", "#Habitos", "#Rutina", "#DeepWork", "#Biohacking"] }
    }
  },
  burnout_survivor: {
    id: "burnout_survivor",
    ...
    lenses: {
      fr: { hooks: [], reframes: ["Je ne compte plus mes heures, je compte mon énergie.", "Ralentir pour aller loin.", "Votre santé est votre vrai ROI.", "Le succès sans paix est un échec.", "Dire non est un acte d'amour."], lessons: [], ctas: ["Prenez soin de vous ouverts ?", "Zen ?", "Energie ?", "Besoin d'aide ?"], hashtags: ["#MentalHealth", "#Burnout", "#Wellbeing", "#SelfCare", "#Peace"] },
      en: { hooks: [], reframes: ["I don't count hours, I count energy.", "Slow down to speed up.", "Health is your real ROI.", "Success without peace is failure.", "Saying no is self-love."], lessons: [], ctas: ["Take care?", "Zen?", "Energy?", "Need help?"], hashtags: ["#MentalHealth", "#Burnout", "#Wellbeing", "#SelfCare", "#Peace"] },
      es: { hooks: [], reframes: ["Ya no cuento horas, calculo mi energía útil.", "Aflojar el paso salva vidas.", "Tu salud es el mejor ROI.", "Éxito sin paz es un fracaso.", "Decir no es amor propio."], lessons: [], ctas: ["¿Te cuidas lo suficiente?", "¿Zen?", "¿Energía?", "¿Ayuda?"], hashtags: ["#SaludMental", "#Bienestar", "#Burnout", "#Cuidados", "#Paz"] }
    }
  }
};
